<?php
$page_title = "Privacy Policy | TwitterGIF";
$page_desc = "Our privacy policy outlines how we handle your data and ensure your privacy while using TwitterGIFDownloader.";
include 'header.php';
?>
    ...
    <div class="pt-32 pb-20 container mx-auto px-4 max-w-4xl">
        <div class="text-center mb-16">
            <div class="inline-flex items-center justify-center p-4 rounded-3xl bg-indigo-50 text-primary mb-6 shadow-sm shadow-indigo-100/50">
                <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
            </div>
            ...
            <p class="text-slate-400 font-semibold">Last Updated: May 2026</p>
        </div>
